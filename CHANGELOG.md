...
- put hp search parameter in dict
- in defaults set seed to 0 instead of null
...
- fix times in saved prediction probabilities
...
- update model from new run (ms revisions)
- minor formatting
...
[3.0.2]:https://github.com/ethz-tb/orcAI/releases/tag/v3.0.2
