...
#SBATCH --output=Results/cnn_res_lstm_model/logs/output_%j.log
#SBATCH --error=Results/cnn_res_lstm_model/logs/error_%j.log
...
Train_and_Test/train_model.py -c euler -m cnn_res_lstm_model -d "$TMPDIR/" -p /cluster/home/sbonhoef/OrcAI_project/
