#!/usr/bin/bash
#SBATCH --job-name=cnn
#SBATCH --output=Results/cnn_res_model/logs/output_%j.log
#SBATCH --error=Results/cnn_res_model/logs/error_%j.log
...
Train_and_Test/train_model.py -c euler -m cnn_res_model -d "$TMPDIR/" -p /cluster/home/sbonhoef/OrcAI_project/ 
