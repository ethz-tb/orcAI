...
#rsync -avz Scripts/* sbonhoef@euler.ethz.ch:OrcAI_project/Scripts/
#rsync -avz *.py sbonhoef@euler.ethz.ch:OrcAI_project/

rsync -avz {Train_and_Test/*.py,MakeData/*.py,GenericParameters/*,Scripts/*,*.py,Results/*/*.dict} sbonhoef@euler.ethz.ch:OrcAI_project/
